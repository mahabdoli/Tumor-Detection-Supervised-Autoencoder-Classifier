...
# Constants.
DATA_PATH = '/content/drive/MyDrive/med/input'
IMAGE_SIZE = 224
DEVICE = 'cpu'
...
checkpoint = torch.load('/content/drive/MyDrive/med/outputs/model.pth', map_location=DEVICE)
...
for image_path in all_image_paths:
    ...
    cv2.waitKey(0)
    cv2.imwrite(f"/content/drive/MyDrive/med/outputs/{gt_class_name}.png", orig_image)